...
<script>
  ...
  <body id="main">
    <!-- LOGIN SECTION  -->
	<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v10.0" nonce="<?php echo uniqid(); ?>"></script>
            ...
            <div class="login__right login__pad">
			  ...
			  <div class="fxt-content fxt-template-layout1">
				...
				<div class="fxt-form"> 
					...
					<form class="needs-validation"  id="login_form" autocomplete="off">
						...
						<div class="form-group">
							<div class="fxt-transformY-50 fxt-transition-delay-3">
								...
								<div id="result"><?php echo $session->getFlashdata('msg'); ?></div>
							</div>
						</div>
					</form>
				</div>
				<div class="login__social" style="text-align:center;">
                <p class="--para"><a href="<?php echo base_url(); ?>signup"  class="btn btn-primary">New user? - Signup</a></p>
				</div>
				<div class="login__social" style="text-align:center;">
					...
					<ul class="fxt-socials-links">
						<li class="">
						 <div class="facebook-login">
							...
							<button id="custom-facebook-button"><i class="fab fa-facebook-square"></i> Login with Facebook</button>
						 </div>

						<!--
						<a href="https://www.facebook.com/v10.0/dialog/oauth?client_id=1990203758045194&redirect_uri=https://get-transcription.com/callback&scope=email">
...
<script>
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
				url: BASE_URL+"Auth/ci_login_ajax",
				type: "POST",
				data: formData,
				dataType: "JSON",
				beforeSend: function() {
	     ...
	     document.getElementById('custom-facebook-button').addEventListener('click', function() {
		 console.log(FB);
  FB.login(function(response) {

    if (response.status === 'connected') {
      // User is logged into your app and Facebook.
      // You can make an AJAX call to your server to handle the login.
