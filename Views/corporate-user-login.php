...
<script>
  ...
  <body id="main">
  <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v18.0" nonce="W2cIPa0F"></script>

    <!-- LOGIN SECTION  -->
	<p id="flashmsg"><?php echo $session->getFlashdata('msg'); ?></p>
    <div class="login">
      <div class="container">
          ...
          <div class="col-lg-6">
            <div class="login__right login__pad">
			  ...
			  <div class="fxt-content fxt-template-layout1">
                ...
                <p class="--para"><a href="<?php echo base_url(); ?>corporate-user-signup"  class="btn btn-primary">New user? - Signup</a></p>
				</div>
				<div class="login__social" style="text-align:center;">
...
<script>
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
				url: BASE_URL+"Auth/ci_corporate_user_login_ajax",
				type: "POST",
				data: formData,
				dataType: "JSON",
				beforeSend: function() {
