...
if(($_GET['paymentId'] == '') || ($_GET['token'] == '') || ($_GET['PayerID'] == ''))
{	
	return redirect->to(base_url());
}

$url = "http://gotranscript.tridentdispatch.com/ci4/upload_files";
$ch = curl_init();
$timeout = 50;
...
?>
        ...
        <!-- Content Start -->
        <table cellpadding="0" cellspacing="0" cols="1" bgcolor="#d7d7d7" align="center" style="max-width: 600px; margin:100px auto;">
            <tr bgcolor="#d7d7d7">
                        ...
                        <tr align="left">
                            ...
                            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">
                                    Hi <?php echo ($session->get('userdata')['user_fullname']); ?>, 
                                </p>
                            </td>
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        </tr>
...
Amount: $ <?php echo $totalPrice; ?> <br/></p>
                                    <br>
                        ...
                        <tr align="center">
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><strong>Transcation ID: <?php echo $_GET['paymentId']; ?></strong></p>
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">Order date: <?php echo date('d-m-Y h:i A'); ?></p>
...
$( document ).ready(function() {
	...
	function updateTranscation()
	{
		$.ajax({
			type: 'POST',
			url: BASE_URL+'Payment/updateTranscation',
			data: {'order_id':'<?php echo $order_id; ?>', 'paymentId': '<?php echo $_GET['paymentId']; ?>', 'token': '<?php echo $_GET['token']; ?>', 'PayerID': '<?php echo $_GET['PayerID']; ?>', 'amount': '<?php echo $totalPrice; ?>', 'page': 'success' },
			dataType:'json',
			beforeSend: function()
			{
			},
